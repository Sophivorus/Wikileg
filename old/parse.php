...
class WikilegParseScript extends Maintenance {
	...
	public function execute() {
		...
		$text = WikilegParser::enlaces( $text );
		$text = WikilegParser::secciones( $text );
		$text = WikilegParser::citas( $text );
		$text = WikilegParser::listas( $text );
		$text = WikilegParser::notas( $text );
		$text = WikilegParser::imagenes( $text, $source );
		$text = WikilegParser::limpiar( $text );

		// Create the page
		$User = User::newSystemUser( 'Wikileg' );
...
$maintClass = WikilegParseScript::class;
